...
namespace FillingOutForms
{
    ...
    public class AutoCompleteView : ContentView
    {
        ...
        /// <summary>
        /// The show control property.
        /// </summary>
        //public static readonly BindableProperty ShowControl = BindableProperty.Create<AutoCompleteView, bool>(p => p.Show, false, BindingMode.TwoWay, null);
